...
function App() {
  ...
  const getPage = () => ['events', 'business', 'about', 'privacy', 'terms'].includes(location.hash.slice(1)) ? location.hash.slice(1) : 'home';
  ...
  const content = page === 'events' ? <EventsPage /> : page === 'business' ? <BusinessPage /> : page === 'about' ? <AboutPage /> : page === 'privacy' ? <PrivacyPage /> : page === 'terms' ? <TermsPage /> : <><Hero /><Features /><Screenshots /><HowItWorks /><Categories /><Cta /></>;
